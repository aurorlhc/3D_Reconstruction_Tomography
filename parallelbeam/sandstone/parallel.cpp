...
#define MAXY 128
#define MAXZ 128
#define Lmax 90 //determing the receptor resolution, the unit is one pixel
...
#define PI 3.1415926
#define N_p 60 //number of projections, which are assumed to be evenly distributed over pi  
...
void print_projections()
{
  ...
  fout2.open("target_projection.vtk");
  ...
  fout2<<"DIMENSIONS 181 181 60"<<endl;
  fout2<<"SPACING 1 1 1"<<endl;
  fout2<<"ORIGIN 0 0 0"<<endl;
  fout2<<"POINT_DATA 1965660"<<endl;
