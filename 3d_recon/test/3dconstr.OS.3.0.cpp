...
//int Nconf = 1;
int Nevl = 2000000;//times of evlovtion, on average, each pixel is moved 0.5 times... far form equilirum at each stage... but just for test...
...
main()
{
  ...
  init_configII();//initialize configuration.
