...
int Nevl = 10000000; //maximum trials at a T-stage

double alpha = 0.98; //cooling rate

int TN = 1000; //total T-stages

double T = 10.0; //initial temperature
...
//this seems to be a very slow calculation... need to improve!!!!
/*
double get_energy()
{
  double sum = 0;
